...
import com.example.mybatisplussample.ds2.user.mapper.UserMapper2;
 ...
 */
@Service
public class UserServiceImpl2 extends ServiceImpl<UserMapper2, UserEntity2> implements UserService2 {
